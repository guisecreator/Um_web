...
type AddServiceClient interface {
	...
	GetLogin(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
	GetPassword(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
...
func (c *addServiceClient) GetLogin(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.AddService/GetLogin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *addServiceClient) GetPassword(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.AddService/GetPassword", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *addServiceClient) Register(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.AddService/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AddServiceServer interface {
	...
	GetLogin(context.Context, *Request) (*Response, error)
	GetPassword(context.Context, *Request) (*Response, error)
...
func (UnimplementedAddServiceServer) GetLogin(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetLogin not implemented")
}
func (UnimplementedAddServiceServer) GetPassword(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPassword not implemented")
}
func (UnimplementedAddServiceServer) Register(context.Context, *Request) (*Response, error) {
...
func _AddService_GetLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddServiceServer).GetLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AddService/GetLogin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddServiceServer).GetLogin(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}

func _AddService_GetPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddServiceServer).GetPassword(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AddService/GetPassword",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddServiceServer).GetPassword(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}

func _AddService_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddServiceServer).Register(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AddService/Register",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddServiceServer).Register(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AddService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetLogin",
			Handler:    _AddService_GetLogin_Handler,
		},
		{
			MethodName: "GetPassword",
			Handler:    _AddService_GetPassword_Handler,
		},
		{
			MethodName: "Register",
			Handler:    _AddService_Register_Handler,
		},
	},
