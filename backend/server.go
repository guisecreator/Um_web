...
import (
	...
	"github.com/guisecreator/um_backend/db"
	"github.com/guisecreator/um_backend/graphql"
	middleware "github.com/guisecreator/um_backend/pkg/middlewares"
	"github.com/guisecreator/um_backend/pkg/sessions/session"
...
func main() {
	...
	resolver := &graphql.Resolver{
		Db:       database,
		Sessions: session.NewObjectOfSessions(),
	}
